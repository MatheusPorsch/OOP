...
public class Executar {
    ...
    public static void mostrar_entidades(Empresa empresa){
        ...
        while(true){
            ...
            System.out.println("6 - Salvar Empresa");
            System.out.println("7 - Carregar Empresa");
            System.out.println("9 - Sair");
            System.out.println("-----------------------------------");
            ...
            switch(selecao){
                ...
                case 6 -> Persistencia.salvarEmpresa(empresa);
                case 7 -> {
                    Empresa empresaCarregada = Persistencia.carregarEmpresa(empresa.getNome());
                    if (empresaCarregada != null) {
                        empresa = empresaCarregada;
                        dicionarioEmpresas.put(empresa.getNome(), empresa);
                    }
                }
                case 9 -> {
        ...
        while(true){
            ...
            switch(selecao){
                case 1 -> {
                    ...
                    input_correto = false;
                    int captura_Numero_de_passos = -1;
                    while(!input_correto){
                        System.out.println("Número de Passos no Evento:");
                        try {
                            captura_Numero_de_passos = Integer.parseInt(scanner.nextLine());
                            input_correto = true;
                        } catch(NumberFormatException e){
                            System.out.println("Erro: O código deve ser um número!");
                        }
                    ...
                    Evento e = new Evento(codigo, nome, captura_Numero_de_passos);
                    empresa.addEvento(e);
